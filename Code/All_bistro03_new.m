...
clear
dir_Bistro03_hdr = ('C:\HDR\bistro_03\'); % Dirctory of HDR image
 
%=================================Durrand==================================
outputVideoDurrand1 = avifile('Durrand_bistro03.avi'); % Video output
% open(outputVideoDurrand1);

%==============================TumblinRushmeier============================
outputVideoTum1 = avifile('TumblinRushmeier_bistro03.avi'); % Video output
% open(outputVideoTum1);

%================================Logarithmic===============================
outputVideoLog1 = avifile('Logarithmic_bistro03.avi'); % Video output
% open(outputVideoLog1);

%================================Lischinski================================
outputVideoLis1 = avifile('Lischinski_bistro03.avi'); % Video output
% open(outputVideoLis1);

%===============================ReinhardBil================================
outputVideoRein1 = avifile('ReinhardBil_bistro03.avi'); % Video output
% open(outputVideoRein1);


difference=0.2; % Threshold

filename = sprintf('bistro_03_000858.hdr');
...
imgTMO_durrand =  DurandTMO(image, 20,100);
...
imgTMO_log = LogarithmicTMO(image, 3,1);
...
for K=2:170
    K
filename = sprintf('bistro_03_00%04d.hdr', K+857);
file = [dir_Bistro03_hdr, filename];
image=hdrimread(file);
