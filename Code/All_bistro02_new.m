...
clear
dir_Bistro03_hdr = ('C:\HDR\bistro_02\'); % Dirctory of HDR image
 
%=================================Durrand==================================
outputVideoDurrand1 = avifile('Durrand_bistro02.avi'); % Video output
% open(outputVideoDurrand1);

%==============================TumblinRushmeier============================
outputVideoTum1 = avifile('TumblinRushmeier_bistro02.avi'); % Video output
% open(outputVideoTum1);

%================================Logarithmic===============================
outputVideoLog1 = avifile('Logarithmic_bistro02.avi'); % Video output
% open(outputVideoLog1);

%================================Lischinski================================
outputVideoLis1 = avifile('Lischinski_bistro02.avi'); % Video output
% open(outputVideoLis1);

%===============================ReinhardBil================================
outputVideoRein1 = avifile('ReinhardBil_bistro02.avi'); % Video output
% open(outputVideoRein1);


difference=0.2; % Threshold

filename = sprintf('bistro_02_000219.hdr');
...
imgTMO_durrand =  DurandTMO(image, 25,100);
...
imgTMO_Lis = LischinskiTMO(image, 0.1);
...
for K=2:300
    K
filename = sprintf('bistro_02_00%04d.hdr', K+218);
file = [dir_Bistro03_hdr, filename];
image=hdrimread(file);
